  ...
  return (
    ...
    >
      <form
        ...
        className="bg-surface border border-border-strong rounded-2xl max-w-2xl w-full flex flex-col max-h-[90vh] shadow-2xl animate-scale-in"
      >
        {/* Header */}
        <div className="flex justify-between items-center p-6 border-b border-border-strong flex-shrink-0">
          <h3 className="font-bold text-on-surface text-lg">Create New Mentor Profile</h3>
          <button
            type="button"
            onClick={onClose}
            className="text-secondary hover:text-on-surface cursor-pointer p-1 rounded-lg hover:bg-white/5 transition-colors"
          >
            <X size={18} />
          </button>
        </div>
        ...
        {/* Footer */}
        <div className="flex gap-3 justify-end p-6 border-t border-border-strong flex-shrink-0">
          <button
            type="button"
            onClick={onClose}
